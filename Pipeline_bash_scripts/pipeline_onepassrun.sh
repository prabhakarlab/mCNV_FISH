...
python /path/to/your/directory/Pipeline_spot_calling/run_all_bit.py --data_id your_dataset_id --seg_model cellpose_modelD --preprocess_background --registration_mode precomputed -p 8 --fov_file fovs.txt --run_notes run_tracker --flatfield_correction_folder /path/to/your/flatfield_correction_matrices --Cy5_mat_file Cy5_matrix_file_name --Cy3_mat_file Cy3_matrix_file_name
...
python /path/to/your/directory/Pipeline_spot_calling/run_all_bit.py --data_id your_dataset_id --seg_model cellpose_modelD --run_all_bit --registration_mode precomputed --bit all -p 8 --fov_file fovs.txt --run_notes run_tracker --flatfield_correction_folder /path/to/your/flatfield_correction_matrices --Cy5_mat_file Cy5_matrix_file_name --Cy3_mat_file Cy3_matrix_file_name
